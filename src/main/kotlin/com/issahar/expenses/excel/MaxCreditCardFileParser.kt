...
//        }
    ...
    private fun getIsraelExpenseFromRow(row: Row): Expense {
        ...
        return Expense(0, date, name, amount, budgetMonth, 0, originalAmount, "Comment: $comment. Tags: $tags", ExpenseType.CreditCardIsrael)
    }
    ...
    private fun getAbroadExpenseFromRow(row: Row): Expense {
        ...
        val budgetMonth = row.getCell(9).stringCellValue.toDate().budgetMonthFromChargeDate()
        return Expense(0, date, name, amount, budgetMonth, 0, originalAmount, "Card: $cardName. Original Currency: $originalCurrency", ExpenseType.CreditCardAbroad)
    }
